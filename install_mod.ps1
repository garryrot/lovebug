...
Copy-Item -v -r "deploy\41 NukaRide\F4SE\Plugins\Telekinesis2\Actions\*.json" "$ModDeployPath\F4SE\Plugins\Telekinesis2\Actions\" -Force
Copy-Item -v -r "deploy\41 NukaRide\F4SE\Plugins\Telekinesis2\Triggers\*.json" "$ModDeployPath\F4SE\Plugins\Telekinesis2\Triggers\" -Force

Copy-Item -v -r "deploy\42 DD\F4SE\Plugins\Telekinesis2\Triggers\*.json" "$ModDeployPath\F4SE\Plugins\Telekinesis2\Triggers\" -Force
Copy-Item -v -r "deploy\42 DD\F4SE\Plugins\Telekinesis2\Variables\*.json" "$ModDeployPath\F4SE\Plugins\Telekinesis2\Variables\" -Force

Copy-Item -v -r "deploy\51 AAF BP70\F4SE\Plugins\Telekinesis2\Triggers\*.json" "$ModDeployPath\F4SE\Plugins\Telekinesis2\Triggers\" -Force
